...
def generate_launch_description():
    ...
    servo_yaml = load_yaml("panda_servo_control", "config/panda_simulated_config.yaml")
    servo_params = {"panda_servo_control": servo_yaml}

    # RViz
    rviz_config_file = (
        get_package_share_directory("panda_servo_control") + "/config/demo_rviz_config.rviz"
    )
    rviz_node = Node(
        package="rviz2",
        executable="rviz2",
